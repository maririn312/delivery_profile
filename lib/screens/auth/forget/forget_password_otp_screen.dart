...
class ForgetPasswordOtpScreen extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    return _ForgetPasswordOtpScreenState();
  }
}
      ...
      child: GestureDetector(
        ...
        child: Scaffold(
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [_buildLogo(), _buildForgetOtpSection()],
            ),
          ),
        ),
      ),
    ...
    return Column(
      children: [
        Container(
            ...
            width: 800,
            child: const Text(Language.CONF_FORGET,
                style: TextStyle(
                    color: Colors.black,
